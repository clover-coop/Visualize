...
std::tuple<FBuildingBlueprint, FBuildData> BuildingPolyLine::BuildAlongPolyLine(
	...
	float verticesAngle, degreesPerPoint, curDegrees, nextHeightDegrees, curHeightDegrees=0;//smm230627
	int signDirectionHeightDegrees=1, nextHeightDegreesIndex=0, curHeightDegreesIndex=0;//smm230627
